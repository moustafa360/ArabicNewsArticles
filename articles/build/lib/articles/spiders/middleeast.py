...
class MiddleEastSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if next_link and self.counter <= 25210:
    ...
    def clear_input(my_list):
        ...
        for i in range(0, len(my_list)):
            # my_list[i] = MiddleEastSpider.remove_html_tags(my_list[i])
            if "\n" in my_list:
