...
class MasrwayTechSpider(scrapy.Spider):
    name = 'masrway_tech'
    allowed_domains = ['masrawy.com']
    main_link = "https://www.masrawy.com"
    page_index = 1
    business = 'https://www.masrawy.com/listing/SectionMore?categoryId=382&pageIndex={}&hashTag=SectionMore'
