...
class RtSportsOthersSpider(scrapy.Spider):
    name = 'rt_sports_others'
    counter_ = 0
    allowed_domains = ['arabic.rt.com']
    scraped_link = "https://arabic.rt.com/listing/trend.53b3df46611e9bca608b45c8/noprepare/trend/10/{0}"
