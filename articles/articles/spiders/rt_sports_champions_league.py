...
class RtSportsChampionsLeagueSpider(scrapy.Spider):
    name = 'rt_sports_champions_league'
    counter_ = 0
    allowed_domains = ['arabic.rt.com']
    scraped_link = "https://arabic.rt.com/listing/trend.100000000000000009063138/noprepare/trend/10/{0}"
