...
link = "https://www.alarabiya.net/ar/sport/international-sport/archive/mainArea/0/mainContent/0/pArea75/0?&pageNo={}" # 1171
columns = ["article_content", "Tags"]


def main():
    links, returned_data, article_content, tags, temp = [], [], [], [], []
    for num in range(1, 1171):
...
if __name__ == '__main__':
    try:
        data = main()
        data.to_csv("alarabia_sports.csv", index=False)
    finally:
        driver.quit()